...
risk_data = [
    ...
    ['AI 技术迭代滞后', '20%', '-15%', '-8pp', '持续 R&D 15% + DeepSeek/Qwen 合作', '王宇寒'],
    ['大客户流失', '15%', '-10%', '-5pp', '客户成功 2x + 3 年长约', '官馨'],
    ['监管收紧', '30%', '-8%', '-3pp', '法务+合规双保险 + 行业协会', '王宇寒'],
    ['融资环境恶化', '25%', '0', '-5pp', '18 月现金跑道 + 多元融资', '冯亦根'],
    ['核心团队流失', '15%', '-5%', '-4pp', '期权池 15% + 4 年 vesting', '冯亦根'],
    ['竞品价格战', '40%', '-20%', '-6pp', '差异化 + 成本领先 30%', '冯亦根'],
    ['数据源断供', '10%', '-25%', '-12pp', '多源备份 + 自建爬虫', '王宇寒'],
