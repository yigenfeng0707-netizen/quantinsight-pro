...
| 11 | **正式 Word 文档包** | [`03_正式文档_WORD/`](03_正式文档_WORD/) | ✅ 7 份 DOCX |
...
| 文件 | 内容 |
|------|------|
| `01_AFAC2026_规则对照与评分自评.docx` | 官方要求对照 + 五维评分自评表 |
| `02_生产级测试报告.docx` | 单元测试 + POC 回测指标 + 健康检查项 |
| `03_Executive_Summary.docx` | 一页纸 Executive Summary |
| `04_评委FAQ手册.docx` | 10 问 10 答 |
| `05_POC实验报告.docx` | T35 HS300 五策略对比 |
| `06_技术方案白皮书.docx` | 六层架构 + 技术白皮书 |
