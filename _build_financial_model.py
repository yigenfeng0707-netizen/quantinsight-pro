...
risks = [
    ['技术风险', 'AI 模型应用层落地延迟、效果不及预期', '高', '采用开源基础模型（Qwen/DeepSeek）+ 应用层深度优化，6个月内出 MVP', '黄成选'],
    ['市场风险', '机构客户决策慢、试点周期长', '高', '依靠永字资管生态资源快速触达；先做 3-5 家种子客户深度服务', '薛永再'],
    ['合规风险', '金融监管政策变化、AI 备案要求', '中', '冯思涵（Northwestern JD）专门负责合规与法务；保持与监管沟通', '冯思涵'],
    ['人才风险', '核心团队（黄成选、冯思涵）流失', '中', '股权激励+项目分红；浙江大学+清华大学双母校资源招聘', '冯亦根'],
