...
team_rows = [
    ...
    ('参赛团队 (4 人, 冯亦根/王宇寒/官馨/梁理智)', 4, 4, 4, 4, 4, 0, 0),
...
i += 1
ws.cell(row=i, column=1, value='推荐单位战略合作: 永字资管试点合作已签署 (薛永再, 场外顾问)').font = NORMAL_FONT
...
risks = [
    ('AI 技术迭代滞后', '20%', '-15%', '-25%', '-8pp', '持续 R&D 投入 (15% 营收); 与 DeepSeek/Qwen 合作', '王宇寒'),
    ('大客户流失', '15%', '-10%', '-15%', '-5pp', '客户成功团队扩 2x; 签 3 年长约; 定制化粘性', '官馨'),
    ('监管收紧 (数据/AI)', '30%', '-8%', '-12%', '-3pp', '提前 6 月预研; 参与行业协会; 法务 + 合规双保险', '王宇寒'),
    ('融资环境恶化', '25%', '0 (短期)', '-30%', '-5pp', '保持 18 月现金跑道; 拓展产业资本/政府引导基金', '冯亦根'),
    ('核心团队流失', '15%', '-5%', '-10%', '-4pp', '期权池 15%; 关键人 4 年 vesting + 竞业', '冯亦根'),
    ('竞品价格战 (Wind 等)', '40%', '-20%', '-20%', '-6pp', '差异化定位 (中小私募 + AI); 成本领先 30%', '冯亦根'),
    ('数据源断供', '10%', '-25%', '-30%', '-12pp', '多源备份 (Wind/akshare/聚源/通联); 自建爬虫', '王宇寒'),
